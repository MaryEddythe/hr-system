...
<style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        nav .brand-short{ display:none; font-size: 1.15rem; }
        ...
        body.sidebar-closed nav.sidebar{ transform: translateX(calc(-1 * var(--sidebar-width))); }

        body.sidebar-closed .container{ margin-left: 0; }

        /* toggle colors based on sidebar state */
        ...
        body.sidebar-closed .brand-short{ display:inline; }

        /* default brand */
        .brand-short{ display:none; }


        /* move toggle button to stay near sidebar edge */
        nav.sidebar { transition: left 0.2s ease; }
        .sidebar-toggle{ transition: left 0.2s ease, transform 0.15s ease; }
        body.sidebar-closed .sidebar-toggle{ left: 0px; }
